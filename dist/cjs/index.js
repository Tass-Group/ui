...
const Upload = ({ accept, multiple = false, disabled = false, listType = "text", defaultFileList = [], fileList: propFileList, onChange, onRemove, children, className, style }) => {
    const [fileList, setFileList] = React.useState(propFileList ?? defaultFileList);
    ...
    const renderUploadButton = () => {
        ...
        if (listType === "picture-card") {
            return (jsxRuntime.jsxs("div", { className: "upload-card-content", children: [jsxRuntime.jsx(Icon, { name: "pluscircle", size: 24 }), jsxRuntime.jsx("div", { className: "upload-text", children: "Upload" })] }));
        }
        return (jsxRuntime.jsx(Button, { icon: jsxRuntime.jsx(Icon, { name: "upload" }), title: "Upload" }));
    };
    return (jsxRuntime.jsxs(UploadContainer, { className: className, style: style, children: [jsxRuntime.jsx(UploadButton, { onClick: handleClick, disabled: disabled, listType: listType, className: disabled ? "disabled" : "", children: renderUploadButton() }), jsxRuntime.jsx(UploadInput, { ref: inputRef, "data-testid": "upload-input", type: "file", accept: accept, multiple: multiple, onChange: handleChange, style: { display: "none" } }), jsxRuntime.jsx(UploadList, { listType: listType, children: fileList.map(file => (jsxRuntime.jsx(UploadListItem, { listType: listType, children: listType === "picture" || listType === "picture-card"
                        ? (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsx("div", { className: "upload-item-image", children: (file.url != null)
                                        ? (jsxRuntime.jsx("img", { src: file.url, alt: file.name }))
                                        : (jsxRuntime.jsx(Icon, { name: "file", size: 30 })) }), jsxRuntime.jsxs("div", { className: "upload-item-actions", children: [jsxRuntime.jsx(Icon, { name: "eye", className: "action-icon", onClick: () => {
                                                if (file.url != null) {
                                                    window.open(file.url, "_blank");
                                                }
                                            } }), jsxRuntime.jsx(Icon, { name: "trash", className: "action-icon", onClick: () => { void handleRemove(file); } })] })] }))
                        : (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsx(Icon, { name: "link", size: 16, style: {
                                        color: file.status === "error" ? "#ff4d4f" : "#999",
                                        marginRight: 8
                                    } }), jsxRuntime.jsx("div", { className: "upload-item-info", children: jsxRuntime.jsx("span", { className: "upload-item-name", children: file.name }) }), jsxRuntime.jsx(Icon, { name: "trash", style: {
                                        color: file.status === "error" ? "#ff4d4f" : "#999",
                                        cursor: "pointer"
